...
<!--<div style="background:#f0f0f0;border-bottom:1px solid #989898;text-align:center;padding:4px 0;margin-bottom:3px" bis_skin_checked="1">BitTube will be shut down and all data will be transferred to another site in one hour.</div>-->
<div id="masthead" bis_skin_checked="1">
	...
	<form autocomplete="on" class="search-form" action="<?= $site_domain ?>/browse.php" method="get" name="searchForm">
