	...
	<b class="rch5"></b>
									...
									<div class="headerTitleRight">
										(<a href="/profile_comment_all?user=<?php echo htmlspecialchars($username) ?>" class="headers">View All Comments</a>)
									</div>
									<span>Comments</span>
								</div>
</div>
...
<div id="commentsBox" class="basicBoxes">
	<table class="commentsTable">
		<?php $comments=mysqli_query($sql, "SELECT * FROM `profilecomments` WHERE touser = '$name' ORDER BY `id` DESC LIMIT 5");
